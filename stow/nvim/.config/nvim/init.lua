...
vim.keymap.set("n", "<leader>fj", ":bn<CR>", { desc = "Next buffer" })
...
-- LSP SERVER SETUP
vim.lsp.enable({ "pyright", "lua_ls", "texlab", "clangd", "ts_ls", "rust_analyzer" })
...
vim.lsp.config("pyright", {
	...
	-- Add these settings for venv detection
